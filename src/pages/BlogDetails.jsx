...
const BlogDetails = () => {
    ...
    return (
        <div className="font-primary md:mx-4 px-4 md:px-8 text-dark2 text-sm md:text-base mt-10 lg:mt-20">
            ...
            <img data-aos="fade-up" className="max-w-full mx-auto mb-5 md:mb-10" src={cover} alt="" />
            <p data-aos="fade-up" className="mb-5 md:mb-10 text-justify">{description}</p>
            <h3 data-aos="fade-up" className='text-dark1 font-secondary font-bold text-2xl'>{author}</h3>
            <h4 data-aos="fade-up" className='text-dark1 font-secondary tracking-widest mt-2 text-lg'>{date}</h4>
