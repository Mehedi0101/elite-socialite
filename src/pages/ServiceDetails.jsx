...
const ServiceDetails = () => {
    ...
    return (
        <div className="font-primary md:mx-4 px-4 md:px-8 mt-10 lg:mt-20 text-dark2 text-sm md:text-base">
            ...
            <p className="mb-5 md:mb-10">{overview}</p>
            ...
            <p className="mb-5 md:mb-10 font-secondary font-bold text-2xl md:text-3xl text-dark1">Price range: <span className="font-primary text-sm md:text-base font-medium">{price_range}</span></p>
            <div className="mb-5 md:mb-10">
