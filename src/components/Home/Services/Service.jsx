...
const Service = ({ service }) => {
    ...
    return (
        <>
            {
                (id % 2) === 0 ?
                    <div data-aos="fade-left" className={'flex items-center gap-x-10 gap-y-4 mb-14 flex-col md:flex-row-reverse'}>
                    ...
                    :
                    <div data-aos="fade-right" className='flex items-center gap-x-10 gap-y-4 mb-14 flex-col md:flex-row'>
                        <div className='w-full md:w-1/2'>
                            <img className='min-h-full' src={image} alt="" />
                        </div>
                        <div className='w-full md:w-1/2 text-center md:text-left'>
